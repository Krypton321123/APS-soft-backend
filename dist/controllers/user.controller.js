...
export const fetchParties = asyncHandler((req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
export const fetchParty = asyncHandler((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        let party;
        if (outstanding) {
            party = Object.assign(Object.assign({}, partyDetails), { outstanding: outstanding });
        }
        else {
            party = Object.assign({}, partyDetails);
        }
        if (!party) {
...
export const fetchUsersByLocation = asyncHandler((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
export const uploadPartyImagesWithMulter = asyncHandler((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return res.status(200).json(new ApiResponse(200, "goood", {}));
}));
...
export const markAttendance = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const attendance = yield prisma.attendance.upsert({
            ...
            create: Object.assign({ userId: userId, date: attendanceDate }, attendanceData)
        });
...
export const fetchRates = asyncHandler((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { date } = req.body;
    ...
    const rates = yield prisma.dailyRateList.findMany({
        where: {
            date: {
                gte: targetDate,
                lt: nextDate
...
export const submitRates = asyncHandler((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    console.log(arr);
    try {
        const rates = yield Promise.all(arr.map((item) => __awaiter(void 0, void 0, void 0, function* () {
            const untcd = item[0];
            console.log(untcd);
            const values = item[1];
            console.log(arr[1]);
            let insertData = { untcd, date: targetDate };
            ...
            yield prisma.dailyRateList.create({
                data: insertData
            });
        })));
...
export const getPreSummary = asyncHandler((req, res) => __awaiter(void 0, void 0, void 0, function* () {
